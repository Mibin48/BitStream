...
export const Component = () => {
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-white"
      )}
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-3xl mx-auto space-y-6 pointer-events-none">
        ...
        <div className="flex gap-4 pointer-events-auto">
          <button 
              ...
              className="px-8 py-3 bg-purple-600 text-white font-semibold rounded-md hover:bg-purple-700 transition-all shadow-md active:scale-95"
          >
              Interact ({count})
          </button>
          <button 
              className="px-8 py-3 bg-slate-100 text-slate-900 font-semibold rounded-md hover:bg-slate-200 transition-all active:scale-95"
          >
              Learn More
          </button>
        </div>
...
export const GridPattern = ({ offsetX, offsetY, className }: { offsetX: any, offsetY: any, className?: string }) => {
  return (
